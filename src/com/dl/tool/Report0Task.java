...
public class Report0Task implements Runnable {
    ...
    private static final Logger logger = LogManager.getLogger(Report0Task.class);
                            ...
                            if (cellstr!=null) {
                                switch (cellstr) {
                                    case "#04":
                                        ...
                                        break;
                                    case "#05":
                                        if(tdata.containsKey("min"))  vv = ((HashMap)tdata.get("min")).get("minv").toString();
                                        break;
                                    case "#06":
                                    ...
                                    case "#08":
                                        ...
                                        break;
                                    case "#09":
                                        if(tdata.containsKey("min"))  vv = ((HashMap)tdata.get("min")).get("mint").toString().substring(5)    ;
                                        break;
                                    default:
                                        vv = "";
                                        break;

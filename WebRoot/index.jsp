...
<html lang="en">
    <head>
        ...
        <link href="un_0_/favicon.ico" rel="icon" type="image/x-icon" />
        <link href="un_0_/favicon.ico" rel="shortcut icon" type="image/x-icon" />
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="upper" class="curved container">
                ...
                <div id="notice">
                    <img src="un_0_/tomcat.png" alt="[tomcat logo]" />
                    <div id="tasks">
